...
def solve(lane_sound ,traffic_sound ,road_lanes ,traffic_sign):
	soundDictCreation()
	if (lane_sound =="No" and traffic_sound=="No" and road_lanes=="No" and traffic_sign=="No"):
		return 0
	elif traffic_sign=="No" and traffic_sound=="Yes" and road_lanes=="No" and lane_sound=="No":
		return 0
	...
	elif (lane_sound=="Yes" and road_lanes=="Yes" and traffic_sign=="No" and traffic_sound=="No"):
		# model_path = "models/tusimple_18.pth"
		model_path = "models/culane_18.pth"
		# model_type = ModelType.TUSIMPLE
		model_type = ModelType.CULANE
		...
		cap.release()
		cv2.destroyAllWindows()
	elif (lane_sound=="No" and road_lanes=="Yes" and traffic_sign=="No" and traffic_sound=="No"):
		# model_path = "models/tusimple_18.pth"
		model_path = "models/culane_18.pth"
		# model_type = ModelType.TUSIMPLE
		model_type = ModelType.CULANE
