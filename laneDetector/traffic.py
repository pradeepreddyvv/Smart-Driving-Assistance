...
class ModelConfig():
    ...
    def __init__(self, model_type):
        self.init_traffic_config()


    def init_traffic_config(self):
        self.img_w = 1640
        self.img_h = 590
...
class laneDetector():
	...
	def __init__(self, model_path, model_type=ModelType_Traffic.TUSIMPLE, use_gpu=False):
			...
			if(len(left_line)>=2 and len(right_line)>=2):
				...
				if prev_x==-10000:
					...
					if abs(prev_x-bcenterx)>200: 	
						...
						playsound('laneDetector/sounds2.mp3')
						change_colour = True
					prev_x=bcenterx
